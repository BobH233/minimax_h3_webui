...
: "${H3_SECONDARY_MASTER_PORT:=30105}"
: "${H3_SECONDARY_SCHEDULER_PORT:=30155}"
...
export H3_INSTANCE_MASTER_PORT="$H3_SECONDARY_MASTER_PORT"
export H3_INSTANCE_SCHEDULER_PORT="$H3_SECONDARY_SCHEDULER_PORT"
